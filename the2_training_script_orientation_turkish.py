...
'''
    ...
    Everything is the same as Orientation Training Script except the used "text" attribute in Turkish.
'''
...
if __name__ == "__main__":
    ...
    trainer.save_model("./fine_tuned_model_turkish")
    print("Model saved.")
